...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct FundUserLiquidationState {
    pub bump: u8,
    pub liquidation_id: u64,
    pub liquidation_token_amount: u64,
}
...
pub struct FundInfo {
    ...
    pub amount_invested_usd: u64,
    pub amount_removed_usd: u64,
    pub current_assets_usd: u64,
...
impl FundUserLiquidationState {
    ...
    pub fn pack(&self, output: &mut [u8]) -> Result<usize, ProgramError> {
        ...
        let output = array_mut_ref![output, 0, FundUserLiquidationState::LEN];

        let (bump_out, liquidation_id_out, liquidation_token_amount_out) =
            mut_array_refs![output, 1, 8, 8];

        bump_out[0] = self.bump;
        *liquidation_id_out = self.liquidation_id.to_le_bytes();
        *liquidation_token_amount_out = self.liquidation_token_amount.to_le_bytes();
    ...
    pub fn unpack(input: &[u8]) -> Result<Self, ProgramError> {
        ...
        let input = array_ref![input, 0, FundUserLiquidationState::LEN];
        #[allow(clippy::ptr_offset_with_cast)]
        let (bump, liquidation_id, liquidation_token_amount) = array_refs![input, 1, 8, 8];

        Ok(Self {
            bump: bump[0],
            liquidation_id: u64::from_le_bytes(*liquidation_id),
            liquidation_token_amount: u64::from_le_bytes(*liquidation_token_amount),
        })
    }
}
...
impl FundAssets {
    ...
    pub fn pack(&self, output: &mut [u8]) -> Result<usize, ProgramError> {
        ...
        let (
            ...
            cycle_end_time_out,
        ) = mut_array_refs![output, 1, 8, 8, 8, 8, 8, 8];
    ...
    pub fn unpack(input: &[u8]) -> Result<Self, ProgramError> {
        ...
        let (
            ...
            cycle_start_time,
            cycle_end_time,
        ) = array_refs![input, 1, 8, 8, 8, 8, 8, 8];
        ...
        Ok(Self {
            ...
            current_assets_usd: u64::from_le_bytes(*current_assets_usd),
...
impl FundCustody {
    ...
    pub fn pack(&self, output: &mut [u8]) -> Result<usize, ProgramError> {
        ...
        *custody_id_out = self.custody_id.to_le_bytes();
        ...
        pyth_price_info_out.copy_from_slice(self.pyth_price_info.as_ref());
        *liquidation_id_out = self.liquidation_id.to_le_bytes();
        *liquidation_token_amount_out = self.liquidation_token_amount.to_le_bytes();
        bump_out[0] = self.bump;
    ...
    pub fn unpack(input: &[u8]) -> Result<Self, ProgramError> {
        ...
        Ok(Self {
            ...
            pyth_price_info: Pubkey::new_from_array(*pyth_price_info),
            liquidation_id: u64::from_le_bytes(*liquidation_id),
            liquidation_token_amount: u64::from_le_bytes(*liquidation_token_amount),
            bump: bump[0],
        })
...
impl Fund {
    ...
    pub fn pack(&self, output: &mut [u8]) -> Result<usize, ProgramError> {
        ...
        *refdb_counter_out = self.refdb_counter.to_le_bytes();
        ...
        liquidation_state_out.copy_from_slice(self.liquidation_state.as_ref());
    ...
    pub fn unpack(input: &[u8]) -> Result<Self, ProgramError> {
        ...
        Ok(Self {
            ...
            liquidation_state: Pubkey::new_from_array(*liquidation_state),
        })
    }
}
